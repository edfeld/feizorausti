...
This file allows for custom language translation as well as the setting of the local of the website.
*/
...
window.onload = function() {
	...
	while($row = $query_translations->fetch(PDO::FETCH_ASSOC)){
		echo "translate[" . $counter . "] = '" . $row['translate'] . "';";
		echo "translation[" . $counter . "] = '" . $row['translation'] . "';";
		$counter++;
	}
	?>
